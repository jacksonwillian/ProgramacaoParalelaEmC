...
int main(int argc, char** argv) {
    ...
    // enquanto os barbeiros nao atingiram o objetivo geral, o loop cria clientes
    atingiramObjetivo = 0;
    ...
    // imprimi a quantidade de clientes atendidos por cada barbeiro
    for (i = 0; i < quantBarbeiros; i++) {
